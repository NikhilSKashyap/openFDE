...
# A managed provider call timed out — terminal, but a RUNTIME fault, NOT a human decision. Kept distinct
# from BLOCKED_NEEDS_HUMAN so the inbox/handoff never mislabels it "Council needs you".
...
STATUSES = (STATUS_READY_FOR_CC, STATUS_CLAUDE_WORKING, STATUS_READY_FOR_CODEX_VERIFICATION,
            ...
            STATUS_BLOCKED_NEEDS_HUMAN, STATUS_BLOCKED_PROVIDER_TIMEOUT)
# Terminal: the loop stops here. VERIFIED = success; the BLOCKED_* states escalate.
TERMINAL_STATUSES = (STATUS_VERIFIED, STATUS_BLOCKED_NEEDS_HUMAN, STATUS_BLOCKED_PROVIDER_TIMEOUT)
